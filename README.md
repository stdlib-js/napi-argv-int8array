...
-   **err**: `[out] napi_value*` pointer for storing a JavaScript error. If not provided an `Int8Array`, the function sets `err` with a JavaScript error; otherwise, `err` is set to `NULL`.
...
[test-image]: https://github.com/stdlib-js/napi-argv-int8array/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/napi-argv-int8array/actions/workflows/test.yml?query=branch:main
